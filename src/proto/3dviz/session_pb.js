...
goog.exportSymbol('proto.viz3d.GetSessionResponse', null, global);
/**
 ...
 * @constructor
 */
proto.viz3d.GetSessionResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viz3d.GetSessionResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viz3d.GetSessionResponse.displayName = 'proto.viz3d.GetSessionResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.viz3d.GetSessionResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.viz3d.GetSessionResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viz3d.GetSessionResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viz3d.GetSessionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    createdtimestamp: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viz3d.GetSessionResponse}
 */
proto.viz3d.GetSessionResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viz3d.GetSessionResponse;
  return proto.viz3d.GetSessionResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viz3d.GetSessionResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viz3d.GetSessionResponse}
 */
proto.viz3d.GetSessionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viz3d.GetSessionResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viz3d.GetSessionResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viz3d.GetSessionResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viz3d.GetSessionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getCreatedtimestamp = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setCreatedtimestamp = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getLastupdatedtimestamp = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setLastupdatedtimestamp = function(value) {
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getLastbilledtimestamp = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setLastbilledtimestamp = function(value) {
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getCorrelationid = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setCorrelationid = function(value) {
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getOwner = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setOwner = function(value) {
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getRenderareaid = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setRenderareaid = function(value) {
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getHttpdatalink = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setHttpdatalink = function(value) {
 ...
 * @return {string}
 */
proto.viz3d.GetSessionResponse.prototype.getAppid = function() {
 ...
 * @return {!proto.viz3d.GetSessionResponse} returns this
 */
proto.viz3d.GetSessionResponse.prototype.setAppid = function(value) {
